        ...
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
                    <a class="btn btn-outline-dark" style="margin-bottom: 5px" href="#">افزودن دسته جدید</a>
                    <span style="margin-right: 10px">تعداد کل منوهای اصلی :
                <?php
                ...
                <table class="table table-striped table-advance table-hover">
                    ...
                    foreach ($list_cat as $cat) :
                        ...
                        <tr>
                            ...
                            <td><a href="dashboard.php?page=edit-category&id=<?php echo $cat->id; ?>" class="btn btn-primary btn-xs">
                            ...
                            <td><a href="dashboard.php?page=delete-category&id=<?php echo $cat->id; ?>" class="btn btn-danger btn-xs">
                        ...
                        foreach ($list_subcat as $subcat) :
                            ...
                            <tr>
                                ...
                                <td><a href="dashboard.php?page=edit-category&id=<?php echo $subcat->id; ?>" class="btn btn-primary btn-xs">
                                        <svg class="bi bi-pencil" width="1.2em" height="1.2em"
                                             viewBox="0 0 16 16" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd"
